...
export const orderSettingsSchema = z.object({
  ...
  // Termos/textos que saem no PDF da OS (garantia, autorização, ciência,
  // condições gerais, rodapé, via, assinatura) foram para o Construtor de PDF.
  // Aqui ficam só os textos NÃO exclusivos do PDF da OS.
