...
// Corpo reutilizável de pagamentos de uma OS: resumo (final/pago/saldo + status),
// formulário de registro (gated) e lista com estorno. Usado no diálogo do
// Financeiro e na aba "Pagamentos" do editor da OS.
