...
MODULES = [
    ...
    (
        ...
        [
            ...
            ("manage_part_links", "Vincular peças a serviços e obrigatoriedade", False),
    ...
    (
        ...
        [
            ...
            ("create", "Criar", False),
            ("edit", "Editar", False),
            ("manage_parts", "Gerenciar peças padrão e obrigatoriedade", False),
            ("delete", "Excluir/desativar", False),
            ("reactivate", "Reativar", False),
        ],
    ),
