...
def resync(apps, schema_editor):
    ...
    Aqui: adiciona o módulo ``alerts`` (Central de Notificações) e concede
    ``alerts.view`` aos perfis operacionais, ``alerts.view_financial`` ao
    Financeiro e ``alerts.configure`` ao Administrador.
    """
...
class Migration(migrations.Migration):
    dependencies = [("accounts", "0008_resync_rbac_leads")]
