...
def resync(apps, schema_editor):
    ...
    Aqui: adiciona o módulo ``ai`` (view/edit/use/logs/test) do Assistente de IA e
    concede ``ai.use`` aos perfis Atendente e Técnico (operam textos da OS).
    """
...
class Migration(migrations.Migration):
    dependencies = [("accounts", "0006_resync_rbac_notifications")]
